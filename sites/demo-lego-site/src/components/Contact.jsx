...
function ContactSection({ data, sectionName = 'contact' }) {
  ...
  return (
    <section id={sectionName} className="py-24 px-8 bg-slate-900 text-white">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p 
                  ...
                  data-dock-bind={`${sectionName}.0.email`}
                >
                  {info.email}
                </p>
              </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p 
                  className="font-bold text-lg" 
                  data-dock-bind={`${sectionName}.0.telefoon`}
                >
                  {info.telefoon}
                </p>
              </div>
        ...
        <div className="bg-white/5 p-10 rounded-[40px] border border-white/10 backdrop-blur-xl">
          <form className="space-y-6">
            <div className="grid grid-cols-2 gap-6">
              <input type="text" placeholder="Naam" className="bg-white/10 border border-white/20 rounded-2xl p-4 focus:outline-none focus:border-blue-500 transition-all" />
              <input type="email" placeholder="Email" className="bg-white/10 border border-white/20 rounded-2xl p-4 focus:outline-none focus:border-blue-500 transition-all" />
            </div>
            <textarea placeholder="Bericht" rows="4" className="w-full bg-white/10 border border-white/20 rounded-2xl p-4 focus:outline-none focus:border-blue-500 transition-all"></textarea>
